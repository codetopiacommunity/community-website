    ...
    return (
      ...
      >
        ...
        <Comp
          ...
          ref={ref as any}
          className={cn(
            "relative z-10 w-full sm:w-auto h-12 flex items-center justify-center px-6 text-sm font-bold tracking-wider rounded-none transition-colors uppercase font-sans border-none bg-zinc-900 text-white hover:bg-zinc-800",
            className,
          )}
          {...props}
        >
