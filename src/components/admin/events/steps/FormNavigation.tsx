  ...
  return (
    <div className="px-8 py-8 bg-grey-50/30 border-t-2 border-grey-100 flex items-center justify-between mt-4">
      <div className="flex gap-3">
        <div
          className={`h-2.5 w-10 rounded-full transition-all duration-300 border-2 ${activeTab === "core" ? "bg-black border-black" : "bg-white border-grey-200"}`}
        />
        <div
          className={`h-2.5 w-10 rounded-full transition-all duration-300 border-2 ${activeTab === "timing" ? "bg-black border-black" : "bg-white border-grey-200"}`}
        />
        <div
          className={`h-2.5 w-10 rounded-full transition-all duration-300 border-2 ${activeTab === "action" ? "bg-black border-black" : "bg-white border-grey-200"}`}
        />
      </div>
