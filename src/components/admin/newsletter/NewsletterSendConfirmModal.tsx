      ...
      <DialogContent className="max-w-md bg-white border border-black shadow-2xl rounded-none p-8 overflow-hidden font-mono">
        ...
        <div className="flex flex-col gap-4 mt-8 font-mono">
          <Button
            disabled={isSending}
            onClick={onConfirm}
            className="h-14 rounded-none bg-black text-white text-[10px] items-center justify-center uppercase font-black tracking-[0.2em] hover:bg-grey-800 transition-all border-none shadow-none"
          >
