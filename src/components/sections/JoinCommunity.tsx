...
export default function JoinCommunity() {
    return (
        <section className={`py-20 bg-black text-ct-primary relative overflow-hidden ${spaceGrotesk.className}`}>

            <div className="absolute inset-0 pointer-events-none">
                <div className="absolute inset-0 bg-gradient-to-b from-transparent via-white/5 to-transparent" />
                <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-full max-w-3xl h-72 bg-white/10 rounded-full blur-3xl" />
            ...
            <div className="relative z-10 max-w-4xl mx-auto px-6 text-center">
                ...
                <p className={`text-lg text-ct-secondary max-w-2xl mx-auto leading-relaxed drop-shadow-lg ${archivo.className}`}>
                ...
                <div className="mt-12 flex flex-col sm:flex-row gap-6 justify-center items-center">
                    ...
                    <button
                        type="submit"
                        className="px-8 py-2 bg-foreground text-ct-inverse font-semibold  border border-ct-secondary shadow-[4px_4px_0_0.05rem_rgba(255,255,255,0.4)] transition-all duration-200 ease-out hover:shadow-[2px_2px_0_0.05rem_rgba(255,255,255,0.4)] hover:-translate-x-[1px] hover:-translate-y-[1px] "
                    >
                        JOIN OUR COMMUNITY
                    </button>
